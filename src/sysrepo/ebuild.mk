...
solibs                   := $(call kconf_enabled,SYSREPO_PLUGIND,restconf.so)
...
bins                     := $(call kconf_enabled,SYSREPO_DAEMON,sysrepo-restconf)
...
builtins                 := $(call kconf_enabled,SYSREPO_BUILTIN,builtin.a)
