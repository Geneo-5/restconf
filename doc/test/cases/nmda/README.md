...
Vérifier que le serveur supporte la RFC8527 et que le module est chargé.

---

## 📋 Compatibilité avec restconf-test.yang

| Cas de test | Applicable | URI de test | Nécessite RFC8527 |
|-------------|------------|-------------|---------------------|
| TC-6-001 | ✅ | `/restconf/ds` | ✅ |
| TC-6-002 | ✅ | `/restconf/ds/ietf-datastores:running` | ✅ |
| TC-6-003 | ✅ | `/restconf/ds/ietf-datastores:operational` | ✅ |
| TC-6-004 | ✅ | `/restconf/ds/ietf-datastores:intended` | ✅ |
| TC-6-005 | ⚠️ | `/restconf/ds/ietf-datastores:startup` | ✅ (optionnel) |
| TC-6-006 | ✅ | GET `/restconf/ds/ietf-datastores:running/rt:restconf-test` | ✅ |
| TC-6-007 | ✅ | POST `/restconf/ds/ietf-datastores:running/rt:restconf-test/rt:basic-data` | ✅ |
| TC-6-008 | ✅ | DELETE `/restconf/ds/.../rt:basic-data` | ✅ |
| TC-6-009 | ✅ | GET `/restconf/ds/ietf-datastores:intended/rt:restconf-test` | ✅ |
| TC-6-010 | ✅ | Cohérence Running ↔ Intended | ✅ |
| TC-6-011 | ✅ | Config invalide dans Intended | ✅ |
| TC-6-012 | ✅ | GET `/restconf/ds/ietf-datastores:operational/rt:restconf-test/rt:system/rt:state` | ✅ |
| TC-6-013 | ✅ | Vérifier données `config false` | ✅ |
| TC-6-014 | ✅ | Absence données inutiles | ✅ |
| TC-6-015 | ✅ | Synchronisation Operational | ✅ |
| TC-6-016 | ✅ | Lecture seule Operational | ✅ (405/403 attendu) |
| TC-6-024 à TC-6-028 | ⚠️ | `?with-origin=true` | ✅ (nécessite support serveur) |
| TC-6-029 à TC-6-032 | ✅ | Cohérence entre datastores | ✅ |

**Note** : Les TC-6-024 à TC-6-028 nécessitent que le serveur implémente le paramètre `with-origin` (RFC8527 §5).
...
**Module à utiliser** : `restconf-test.yang` contient des données dans les containers `rt:system` (config) et `rt:system/rt:state` (operational) pour tester les datastores.
...
```
/restconf/ds/ietf-datastores:running/rt:restconf-test
```

### Vérifications

- HTTP 200
- données configurables présentes (ex: `rt:basic-data/rt:device-id`, `rt:basic-data/rt:timeout`)
- structure valide
- absence de données `config false` (ex: `rt:basic-data/rt:uptime` ne doit pas apparaître)
