...
Le module contient des structures adaptées pour tester tous les paramètres RESTCONF.
...
| Cas de test | Applicable | URI/Paramètre de test |
|-------------|------------|----------------------|
| TC-4-001 | ✅ | `/restconf/data/rt:restconf-test?content=config` |
| TC-4-002 | ✅ | `/restconf/data/rt:restconf-test?content=nonconfig` |
| TC-4-003 | ✅ | `/restconf/data/rt:restconf-test?content=all` |
| TC-4-004 | ✅ | `/restconf/data/rt:restconf-test?content=invalid` |
| TC-4-006 à TC-4-013 | ✅ | `/restconf/data/rt:restconf-test?depth=1/2/3/unbounded/0/-1/abc` |
| TC-4-014 à TC-4-025 | ✅ | `/restconf/data/rt:restconf-test?fields=...` (plusieurs combinaisons) |
| TC-4-026 à TC-4-030 | ✅ | `/restconf/data/rt:restconf-test?with-defaults=trim/explicit/report-all/report-all-tagged/invalid` |
| TC-4-031 à TC-4-036 | ✅ | `/restconf/data/rt:restconf-test/rt:interfaces/rt:ordered-queue?insert=first/last/before/after/invalid` |
| TC-4-037 à TC-4-039 | ✅ | `/restconf/data/...?point=...` (insertion avant/après) |
| TC-4-040 à TC-4-042 | ⚠️ | `/restconf/data/rt:restconf-test?with-origin=true/invalid` (nécessite support RFC8527) |
| TC-4-043 à TC-4-055 | ✅ | Combinaisons de paramètres |
...
```
/restconf/data/rt:restconf-test?content=config
```
...
Aucune donnée `config false` ne doit apparaître (ex: `rt:basic-data/rt:uptime` ne doit pas être présent).
