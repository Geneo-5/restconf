...
**Les tests de cette phase ne nécessitent pas de module YANG spécifique** car ils valident l'infrastructure RESTCONF de base.
Cependant, pour les phases suivantes (CRUD, RPC, NMDA, etc.), le module `restconf-test.yang` (namespace: `urn:restconf:test`, prefix: `rt`) doit être chargé.
