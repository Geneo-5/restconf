...
# Doit retourner HTTP 200 avec les données du module
```
...
Les tests décrits dans cette section utilisent le module `restconf-test.yang` qui contient toutes les structures nécessaires.

---

## 📋 Compatibilité avec restconf-test.yang

| Cas de test | Applicable | Structure YANG | URI de test |
|-------------|------------|----------------|-------------|
| TC-3-001 | ✅ | Root data | `/restconf/data` |
| TC-3-002 | ✅ | Container | `/restconf/data/rt:restconf-test/rt:system` |
| TC-3-003 | ✅ | Presence container | `/restconf/data/rt:restconf-test/rt:system/rt:config` |
| TC-3-004 | ✅ | Leaf | `/restconf/data/rt:restconf-test/rt:basic-data/rt:device-id` |
| TC-3-005 | ✅ | List | `/restconf/data/rt:restconf-test/rt:interfaces/rt:interface` |
| TC-3-006 | ✅ | List entry | `/restconf/data/rt:restconf-test/rt:interfaces/rt:interface=eth0` |
| TC-3-007 | ✅ | Non-existent key | `/restconf/data/rt:restconf-test/rt:interfaces/rt:interface=unknown` |
| TC-3-008 | ✅ | Leaf-list | `/restconf/data/rt:restconf-test/rt:access-control/rt:allowed-ips` |
| TC-3-009 | ✅ | Anydata | `/restconf/data/rt:restconf-test/rt:custom-data/rt:vendor-specific` |
| TC-3-010 | ✅ | Anyxml | `/restconf/data/rt:restconf-test/rt:custom-data/rt:legacy-config` |
| TC-3-011 | ✅ | Create list entry | POST `/restconf/data/rt:restconf-test/rt:interfaces/rt:interface` |
| TC-3-012 | ⚠️ | Create container | POST `/restconf/data/rt:restconf-test/rt:system/rt:config` (si autorisé) |
| TC-3-013 | ✅ | Missing key | POST avec clé absente |
| TC-3-014 | ✅ | Invalid key | POST avec clé invalide |
| TC-3-015 | ✅ | Duplicate key | POST avec clé existante |
| TC-3-016 | ✅ | Invalid data | POST avec données invalides |
| TC-3-017 | ✅ | Read-only | PUT sur `/restconf/data/rt:restconf-test/rt:basic-data/rt:uptime` |
| TC-3-018 | ✅ | Full replace | PUT sur `/restconf/data/rt:restconf-test/rt:basic-data` |
| TC-3-019 | ✅ | PUT absent | PUT sur ressource inexistante |
| TC-3-020 | ✅ | PUT invalid | PUT avec payload invalide |
| TC-3-021 | ✅ | PUT read-only | PUT sur `/rt:restconf-test/rt:basic-data/rt:uptime` |
| TC-3-022 à TC-3-026 | ✅ | PATCH | Toutes les opérations PATCH |
| TC-3-027 à TC-3-031 | ✅ | DELETE | Toutes les opérations DELETE |
| TC-3-032 à TC-3-035 | ✅ | URI validation | Validation des URI |
| TC-3-036 à TC-3-038 | ✅ | Representations | JSON/XML/UTF-8 |
| TC-3-039 | ✅ | Mandatory | `/rt:restconf-test/rt:basic-data/rt:device-id` (mandatory) |
| TC-3-040 à TC-3-041 | ✅ | Min/Max elements | `/rt:restconf-test/rt:interfaces/rt:vlan` (min=1, max=4094) |
| TC-3-042 | ✅ | Pattern | `/rt:restconf-test/rt:basic-data/rt:device-id` (pattern) |
| TC-3-043 | ✅ | Range | `/rt:restconf-test/rt:constraints/rt:range-test/rt:percentage-value` |
| TC-3-044 | ✅ | Length | `/rt:restconf-test/rt:constraints/rt:password` |
| TC-3-045 | ✅ | Enum | `/rt:restconf-test/rt:constraints/rt:operation-mode` |
| TC-3-046 | ✅ | Union | `/rt:restconf-test/rt:advanced-types/rt:mixed-value` |
| TC-3-047 | ⚠️ | Decimal64 | `/rt:restconf-test/rt:advanced-types/rt:precision-value` |
| TC-3-048 | ✅ | Leafref | `/rt:restconf-test/rt:advanced-types/rt:default-interface` |
| TC-3-049 | ✅ | When | `/rt:restconf-test/rt:interfaces/rt:advanced-features/rt:advanced-interface` (when) |
| TC-3-050 | ✅ | Must | `/rt:restconf-test/rt:constraints/rt:must-test` (must constraint) |
...
Les tests décrits dans cette section utilisent le module `restconf-test.yang` qui contient toutes les structures YANG nécessaires.
